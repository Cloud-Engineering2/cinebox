...
//
//            // 1. Auditorium을 통해 해당 상영의 모든 좌석 조회
...
//            
//            // 2. 해당 상영의 예매된 좌석 조회
//            List<BookingSeat> bookedSeats = bookingSeatRepository.findByScreen(screen);
...
//                    .noneMatch(bookingSeat -> bookingSeat.getSeat().getSeatId().equals(seat.getSeatId())))
